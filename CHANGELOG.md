...
- **增强 transferSize=0 错误处理**
  - 添加详细的运行时错误提示，包含原因分析和解决方案
  - 在 README 中新增 Q5 常见问题，详细说明 transferSize=0 的原因和解决方法
  - 改进服务端配置文档，突出强调 `Timing-Allow-Origin` 响应头的重要性
  - 优化 Demo 页面的错误提示，提供更友好的用户体验

- **文档优化**
  - README 所有主要标题居中对齐，提升视觉效果
  - 服务端配置部分添加关键配置说明
  - 新增 transferSize=0 问题的完整排查和解决指南

### 📖 文档更新

**新增内容：**
- Q5: transferSize 为 0 怎么办？
  - 详细的原因分析（跨域、缓存、加载失败）
  - 三种解决方案（服务端配置、同域资源、公共 CDN）
  - 浏览器控制台验证方法
  - SDK 错误提示说明

**改进内容：**
- 服务端配置示例添加 `Timing-Allow-Origin` 重点标注
- 所有二级标题使用居中对齐样式
